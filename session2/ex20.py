...
while x != len(user):
    print(
        "Numarul introdus de dumneavoastra are o valoare diferita de cea a lungimii stringului!"
    )
    x = int(input("Introduceti un numar egal cu lungimea stringului: "))

l1 = (
    []
)  # am creat o lista in care voi adauga cu ajutorul unui 'for' toate literele din string
l2 = (
    []
)  # am creat o lista in care voi adauga cu ajutorul unui 'for' toate cifrele de la 0 la x
